...
# Project paths
# PROJECT_ROOT: Hugo project root (set via env var or default to ../../..)
PROJECT_ROOT = Path(os.environ.get("HUGO_PROJECT_ROOT", Path(__file__).resolve().parent.parent.parent))
